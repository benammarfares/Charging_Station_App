...
mainwindow_maintenance::mainwindow_maintenance(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::mainwindow_maintenance)
{
    arduino a;
...
mainwindow_maintenance::~mainwindow_maintenance()
{
    delete ui;
}
...
void mainwindow_maintenance::update_label()
{
...
void mainwindow_maintenance::on_pushButton_ajout_maint_clicked()
{
    maintenance m;
...
void mainwindow_maintenance::on_pushButton_3_maint_clicked()
{
...
void mainwindow_maintenance::on_pushButton_9_maint_clicked()
{
     maintenance m ;// declare and initialize Etmp
...
void mainwindow_maintenance::on_pushButton_4_modifier_maint_clicked()
{
    QString id = ui->lineEdit_idmaintenance->text();
    QString type = ui->combobox_type->currentText();
    QString description = ui->plainTextEdit->toPlainText();
...
void mainwindow_maintenance::on_recherche_textChanged(const QString &arg1)
{
    ui->tableView->setModel(Etmp.afficher_search_result(ui->recherche->text() ));
}

void mainwindow_maintenance::on_comboBox_currentIndexChanged(const QString &arg1)
{
...
void mainwindow_maintenance::on_pushButton_7_maint_clicked()
{
maintenance m ;
m.telechargerPDF();
...
void mainwindow_maintenance::on_pushButton_8_maint_clicked()
{
    maintenance m ;
    QSqlQuery q1,q2,q3;
